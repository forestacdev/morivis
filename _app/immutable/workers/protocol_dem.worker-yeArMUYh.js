(function(){"use strict";let f=null;const A=()=>{if(f!==null)return f;f=!1;const n=5,e=new OffscreenCanvas(n,n).getContext("2d",{willReadFrequently:!0});if(!e)return!1;for(let r=0;r<n*n;r++){const i=r*4;e.fillStyle=`rgb(${i},${i+1},${i+2})`,e.fillRect(r%n,Math.floor(r/n),1,1)}const o=e.getImageData(0,0,n,n).data;for(let r=0;r<n*n*4;r++)if(r%4!==3&&o[r]!==r){f=!0;break}return f},P=async n=>{if(A())try{return n.transferToImageBitmap()}catch{}return await n.convertToBlob()};var I=`#version 300 es
