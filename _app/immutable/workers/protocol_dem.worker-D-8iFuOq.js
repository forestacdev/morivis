let g=null;const P=()=>{if(g!==null)return g;g=!1;const n=5,e=new OffscreenCanvas(n,n).getContext("2d",{willReadFrequently:!0});if(!e)return!1;for(let r=0;r<n*n;r++){const i=r*4;e.fillStyle=`rgb(${i},${i+1},${i+2})`,e.fillRect(r%n,Math.floor(r/n),1,1)}const o=e.getImageData(0,0,n,n).data;for(let r=0;r<n*n*4;r++)if(r%4!==3&&o[r]!==r){g=!0;break}return g},I=async n=>{if(P())try{return n.transferToImageBitmap()}catch{}return await n.convertToBlob()};var L=`#version 300 es
...
}`;const H=new Map,w=(n,t,e)=>{const o=n.createShader(t);return o?(n.shaderSource(o,e),n.compileShader(o),n.getShaderParameter(o,n.COMPILE_STATUS)?o:(console.error("An error occurred compiling the shaders: "+n.getShaderInfoLog(o)),n.deleteShader(o),null)):(console.error("Unable to create shader"),null)},C=n=>{const t=n.getContext("webgl2");if(!t)throw new Error("WebGL not supported");const e=w(t,t.VERTEX_SHADER,b),o=w(t,t.FRAGMENT_SHADER,L);if(!e||!o)throw new Error("Failed to load shaders");const r=t.createProgram();if(!r)throw new Error("Failed to create program");if(t.attachShader(r,e),t.attachShader(r,o),t.linkProgram(r),!t.getProgramParameter(r,t.LINK_STATUS))throw console.error("Unable to initialize the shader program: "+t.getProgramInfoLog(r)),new Error("Failed to link program");t.useProgram(r);const i=t.createBuffer();if(!i)throw new Error("Failed to create position buffer");t.bindBuffer(t.ARRAY_BUFFER,i);const _=new Float32Array([-1,-1,1,-1,-1,1,1,1]);t.bufferData(t.ARRAY_BUFFER,_,t.STATIC_DRAW);const a=t.getAttribLocation(r,"a_position");return t.enableVertexAttribArray(a),t.vertexAttribPointer(a,2,t.FLOAT,!1,0,0),{canvas:n,gl:t,program:r,positionBuffer:i,texturePool:new Map}},G=n=>{let t=H.get(n);if(!t){const e=new OffscreenCanvas(n,n);t=C(e),H.set(n,t)}return t},z=(n,t)=>{const{gl:e,program:o,texturePool:r}=n;let i=0;Object.entries(t).forEach(([_,{image:a,type:f}])=>{const c=e.TEXTURE0+i;let u=r.get(i)??null;const p=!u;p&&(u=e.createTexture(),r.set(i,u)),e.activeTexture(c),e.bindTexture(e.TEXTURE_2D,u);const x=e.getUniformLocation(o,_);e.uniform1i(x,i),f==="height"?e.texImage2D(e.TEXTURE_2D,0,e.RGBA,e.RGBA,e.UNSIGNED_BYTE,a):e.texImage2D(e.TEXTURE_2D,0,e.RGB,256,1,0,e.RGB,e.UNSIGNED_BYTE,a),p&&(e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST)),i++})},y=(n,t,e)=>{for(const[o,{type:r,value:i}]of Object.entries(e)){const _=n.getUniformLocation(t,o);_!==null&&n[`uniform${r}`](_,i)}};let S=Promise.resolve();self.onmessage=n=>{S=S.then(()=>M(n))};async function M(n){const{tileId:t,center:e,left:o,right:r,top:i,bottom:_,demTypeNumber:a,modeNumber:f,mode:c,max:u,min:p,elevationColorArray:x,tile:E,tileSize:m=256,encodeType:T}=n.data;try{const s=G(m),{canvas:A,gl:l,program:d}=s;if(l.viewport(0,0,m,m),l.useProgram(d),c==="relief")y(l,d,{u_dem_type:{type:"1f",value:a},u_mode:{type:"1f",value:f},u_max_height:{type:"1f",value:u},u_min_height:{type:"1f",value:p},u_tile_size:{type:"1f",value:m}}),z(s,{u_height_map_center:{image:e,type:"height"},u_color_map:{image:x,type:"colormap"}});else if(c==="slope"||c==="curvature"){const h={u_dem_type:{type:"1f",value:a},u_mode:{type:"1f",value:f},u_max_slope:{type:"1f",value:u},u_min_slope:{type:"1f",value:p},u_tile_y:{type:"1f",value:E.y},u_tile_z:{type:"1f",value:E.z},u_tile_size:{type:"1f",value:m}};y(l,d,h),z(s,{u_height_map_center:{image:e,type:"height"},u_height_map_left:{image:o,type:"height"},u_height_map_right:{image:r,type:"height"},u_height_map_top:{image:i,type:"height"},u_height_map_bottom:{image:_,type:"height"},u_color_map:{image:x,type:"colormap"}})}else if(c==="aspect"){const h={u_dem_type:{type:"1f",value:a},u_mode:{type:"1f",value:f},u_max_aspect:{type:"1f",value:u},u_min_aspect:{type:"1f",value:p},u_tile_y:{type:"1f",value:E.y},u_tile_z:{type:"1f",value:E.z},u_tile_size:{type:"1f",value:m}};y(l,d,h),z(s,{u_height_map_center:{image:e,type:"height"},u_height_map_left:{image:o,type:"height"},u_height_map_right:{image:r,type:"height"},u_height_map_top:{image:i,type:"height"},u_height_map_bottom:{image:_,type:"height"},u_color_map:{image:x,type:"colormap"}})}l.clear(l.COLOR_BUFFER_BIT),l.drawArrays(l.TRIANGLE_STRIP,0,4);const v=await I(A);if(v instanceof ImageBitmap)self.postMessage({id:t,imageBitmap:v},{transfer:[v]});else if(T==="buffar"){const h=await v.arrayBuffer();self.postMessage({id:t,buffer:h})}else T==="blob"&&self.postMessage({id:t,blob:v})}catch(s){s instanceof Error&&self.postMessage({id:t,error:s.message})}}
