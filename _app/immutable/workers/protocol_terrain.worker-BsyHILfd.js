(function(){"use strict";let c=null;function p(){if(c!==null)return c;c=!1;const t=5,i=new OffscreenCanvas(t,t).getContext("2d",{willReadFrequently:!0});if(!i)return!1;for(let n=0;n<t*t;n++){const o=n*4;i.fillStyle=`rgb(${o},${o+1},${o+2})`,i.fillRect(n%t,Math.floor(n/t),1,1)}const s=i.getImageData(0,0,t,t).data;for(let n=0;n<t*t*4;n++)if(n%4!==3&&s[n]!==n){c=!0;break}return c}async function T(t){if(p())try{return t.transferToImageBitmap()}catch{}return await t.convertToBlob()}var E=`#version 300 es
...
}`;const h=new Map;let d=null;const R=t=>{const r=t.getContext("webgl2");if(!r)throw new Error("WebGL not supported");const i=(a,m,x)=>{const l=a.createShader(m);return l?(a.shaderSource(l,x),a.compileShader(l),a.getShaderParameter(l,a.COMPILE_STATUS)?l:(console.error("An error occurred compiling the shaders: "+a.getShaderInfoLog(l)),a.deleteShader(l),null)):(console.error("Unable to create shader"),null)},s=i(r,r.VERTEX_SHADER,v),n=i(r,r.FRAGMENT_SHADER,E);if(!s||!n)throw new Error("Failed to load shaders");const o=r.createProgram();if(!o)throw new Error("Failed to create program");if(r.attachShader(o,s),r.attachShader(o,n),r.linkProgram(o),!r.getProgramParameter(o,r.LINK_STATUS))throw console.error("Unable to initialize the shader program: "+r.getProgramInfoLog(o)),new Error("Failed to link program");const f=r.createBuffer();if(!f)throw new Error("Failed to create position buffer");r.bindBuffer(r.ARRAY_BUFFER,f);const e=new Float32Array([-1,-1,1,-1,-1,1,1,1]);r.bufferData(r.ARRAY_BUFFER,e,r.STATIC_DRAW);const _=r.getAttribLocation(o,"a_position");r.enableVertexAttribArray(_),r.vertexAttribPointer(_,2,r.FLOAT,!1,0,0);const u=r.getUniformLocation(o,"u_height_map"),g=r.getUniformLocation(o,"u_dem_type");if(!u||!g)throw new Error("Failed to get uniform locations");return{canvas:t,gl:r,program:o,positionBuffer:f,heightMapLocation:u,demTypeLocation:g}},b=t=>{let r=h.get(t);if(!r){const i=new OffscreenCanvas(t,t);r=R(i),h.set(t,r)}return r};self.onmessage=async t=>{const{id:r,image:i,demTypeNumber:s,tileSize:n=256}=t.data;try{const o=b(n),{canvas:f,gl:e,program:_,heightMapLocation:u,demTypeLocation:g}=o;e.viewport(0,0,n,n),d||(d=e.createTexture()),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,d),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,e.RGBA,e.UNSIGNED_BYTE,i),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.LINEAR),e.useProgram(_),e.uniform1i(u,0),e.uniform1f(g,s),e.clear(e.COLOR_BUFFER_BIT),e.drawArrays(e.TRIANGLE_STRIP,0,4);const a=await T(f);if(a instanceof ImageBitmap)self.postMessage({id:r,imageBitmap:a},{transfer:[a]});else{const m=await a.arrayBuffer();self.postMessage({id:r,buffer:m})}}catch(o){o instanceof Error&&self.postMessage({id:r,error:o.message})}}})();
