...
self.onmessage = async (e) => {
	...
	try {
		...
		// テクスチャのフィルタリングの設定
		gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.LINEAR_MIPMAP_LINEAR); // 高品質なミップマップフィルタリング
		gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.LINEAR); // 高品質な拡大フィルタリング
