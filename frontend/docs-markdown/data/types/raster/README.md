...
[morivis TypeDoc](../../../README.md) / data/types/raster
...
- [RasterBandProperties](interfaces/RasterBandProperties.md)
...
- [RasterCategoryProperties](interfaces/RasterCategoryProperties.md)
...
- [RasterGeoZarrEntry](interfaces/RasterGeoZarrEntry.md)
...
- [BandTypeKey](type-aliases/BandTypeKey.md)
- [BaseMapRasterEntry](type-aliases/BaseMapRasterEntry.md)
- [CadRasterEntry](type-aliases/CadRasterEntry.md)
- [CategoricalRasterEntry](type-aliases/CategoricalRasterEntry.md)
...
- [DemRasterEntry](type-aliases/DemRasterEntry.md)
- [DemStyleMode](type-aliases/DemStyleMode.md)
- [DemStyleModeNum](type-aliases/DemStyleModeNum.md)
- [MorivisRasterEntry](type-aliases/MorivisRasterEntry.md)
...
- [TiffRasterEntry](type-aliases/TiffRasterEntry.md)
- [TileSize](type-aliases/TileSize.md)
- [ZoomLevel](type-aliases/ZoomLevel.md)
