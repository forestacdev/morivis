...
export const propData: PropData = {
	...
	// アカデミー施設
	fac_center: {
		image: `${FEATURE_IMAGE_BASE_PATH}/fac_center/01.webp`,
	...
	fac_cottage: {
		image: `${FEATURE_IMAGE_BASE_PATH}/fac_cottage/01.webp`,
	...
	fac_forest_labo: {
		image: `${FEATURE_IMAGE_BASE_PATH}/fac_forest_labo/01.webp`,
		description: `情報システムを支える情報処理室や数多くの関連図書を保有する図書室を備えます。
                このほか、森の分野と環境の分野に関連する研究施設を備えています。`,
		url: 'https://www.forest.ac.jp/facilities/centerzone/'
	},
	fac_kakoutou: {
		image: `${FEATURE_IMAGE_BASE_PATH}/fac_kakoutou/01.webp`,
		description: '',
		url: null
	},
	fac_kensyutou: {
		image: `${FEATURE_IMAGE_BASE_PATH}/fac_kensyutou/01.webp`,
		description: '',
		url: null
	},
	fac_koubou: {
		image: `${FEATURE_IMAGE_BASE_PATH}/fac_koubou/01.webp`,
		description: `一般県民向けの木工講座などをサポートする施設工作に関するさまざまな木工機械などを備えています`,
		url: 'https://www.forest.ac.jp/facilities/testroom/'
	},
	fac_morinos: {
		image: `${FEATURE_IMAGE_BASE_PATH}/fac_morinos/01.webp`,
		description: `すべての人と森をつなぎ、森と暮らす楽しさと森林文化の豊かさを次世代に伝えていく「森の入り口」森林総合教育センターです。`,
		url: 'https://morinos.net/'
	},
	fac_open_labo: {
		image: `${FEATURE_IMAGE_BASE_PATH}/fac_open_labo/01.webp`,
		description: '',
		url: 'https://www.forest.ac.jp/facilities/testroom/'
	},
	fac_ringyoukikaitou: {
		image: `${FEATURE_IMAGE_BASE_PATH}/fac_ringyoukikaitou/01.webp`,
		description: `高性能林業機械を格納し、その技術を学ぶための学習施設`,
		url: 'https://www.forest.ac.jp/facilities/fmeb/'
	},
	fac_seizaitou: {
		image: `${FEATURE_IMAGE_BASE_PATH}/fac_seizaitou/01.webp`,
		description: '',
		url: 'https://www.forest.ac.jp/facilities/testroom/'
	},
	fac_syako: {
		image: `${FEATURE_IMAGE_BASE_PATH}/fac_syako/01.webp`,
		description: '',
		url: null
	},
	fac_wood_labo: {
		image: `${FEATURE_IMAGE_BASE_PATH}/fac_wood_labo/01.webp`,
		description:
			'木造建築スタジオや作業室、塗装・乾燥室など木の分野に関連する施設を備えています。２棟を繋ぐように大きな作業デッキが前面に広がります。',
		url: 'https://www.forest.ac.jp/facilities/centerzone/'
	},
	fac_tech_a: {
		image: `${FEATURE_IMAGE_BASE_PATH}/fac_tech_a/01.webp`,
	...
	fac_tech_b: {
		image: `${FEATURE_IMAGE_BASE_PATH}/fac_tech_b/01.webp`,
		description: `研修施設と高性能林業機械の保管庫を備える施設前面の広大な実習用グラウンドと合わせて森林技術者のための短期技術研修部門のエリア、テクニカルゾーンを構成します。`,
		url: 'https://www.forest.ac.jp/facilities/technicalzone/'
	},
	fac_information: {
		image: `${FEATURE_IMAGE_BASE_PATH}/fac_information/01.webp`,
		description:
	...
	// 自力建設
	ziriki_01: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_01/01.webp`,
		description: `
            2001年度自力建設。
	...
	ziriki_02: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_02/01.webp`,
		description: `
            2002年度自力建設。
	...
	ziriki_03: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_03/01.webp`,
		description: `
            2003年度自力建設。
	...
	ziriki_04: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_04/01.webp`,
		description: `
            2004年度自力建設。
	...
	ziriki_05: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_05/01.webp`,
		description: `
            2005年度自力建設。
	...
	ziriki_06: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_06/01.webp`,
		description: `
            2006年度自力建設。
	...
	ziriki_07: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_07/01.webp`,
		description: `
            2007年度自力建設。
	...
	ziriki_08: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_08/01.webp`,
		description: `
            2008年度自力建設。
	...
	ziriki_09: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_09/01.webp`,
		description: `
            2009年度自力建設。
	...
	ziriki_10: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_10/01.webp`,
		description: `
            2010年度自力建設。
	...
	ziriki_11: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_11/01.webp`,
		description: `
            2011年度自力建設。
	...
	ziriki_12: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_12/01.webp`,
		description: `
            2012年度自力建設。
	...
	ziriki_13: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_13/01.webp`,
		description: `
            2013年度自力建設。
	...
	ziriki_14: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_14/01.webp`,
		description: `
            2014年度自力建設。
	...
	ziriki_15: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_15/01.webp`,
		description: `
            2015年度自力建設。
	...
	ziriki_16: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_16/01.webp`,
		description: `
            2016年度自力建設。
	...
	ziriki_17: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_17/01.webp`,
		description: `
            2017年度自力建設。
	...
	ziriki_18: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_18/01.webp`,
		description: `
            2018年度自力建設。
	...
	ziriki_19: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_19/01.webp`,
		description: `
            2019年度自力建設。
	...
	ziriki_20: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_20/01.webp`,
		description: `
            2020年度自力建設。
	...
	ziriki_21: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_21/01.webp`,
		description: `
            2021年度自力建設。
	...
	ziriki_22: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_22/01.webp`,
		description: `
            2022年度自力建設。
	...
	ziriki_23: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_23/01.webp`,
		description: `
            2023年度自力建設。
	...
	ziriki_24: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_24/01.webp`,
		description: `
            2024年度自力建設。
	...
	ziriki_25: {
		image: `${FEATURE_IMAGE_BASE_PATH}/ziriki_25/01.webp`,
		description: `
            2025年度自力建設。
	...
	// },
	aozyutaki: {
		image: `${FEATURE_IMAGE_BASE_PATH}/aozyutaki/01.webp`,
		description: '',
		url: null
	},
	azumaya_1: {
		image: `${FEATURE_IMAGE_BASE_PATH}/azumaya_1/01.webp`,
		description: '',
		url: null
	},
	azumaya_kezikabora: {
		image: `${FEATURE_IMAGE_BASE_PATH}/azumaya_kezikabora/01.webp`,
		description: '',
		url: null
	},
	gate_kokuyurin: {
		image: `${FEATURE_IMAGE_BASE_PATH}/gate_kokuyurin/01.webp`,
		description: '',
		url: null
	},
	hebiotaki: {
		image: `${FEATURE_IMAGE_BASE_PATH}/hebiotaki/01.webp`,
		description: '',
		url: null
	},
	heihuuiwa: {
		image: `${FEATURE_IMAGE_BASE_PATH}/heihuuiwa/01.webp`,
		description: '',
		url: null
	},
	hirumesiiwa: {
		image: `${FEATURE_IMAGE_BASE_PATH}/hirumesiiwa/01.webp`,
		description: '',
		url: null
	},
	kezikaboraike: {
		image: `${FEATURE_IMAGE_BASE_PATH}/kezikaboraike/01.webp`,
		description: '岐阜県美濃市内に所在する農業用ため池',
		url: null
	},
	miharasiiwa: {
		image: `${FEATURE_IMAGE_BASE_PATH}/miharasiiwa/01.webp`,
		description: '美濃市の街中を一望することができる岩場',
		url: null
	},
	// mokudou: {
	// 	image: `${FEATURE_IMAGE_BASE_PATH}/mokudou/01.webp`,
	// 	description: '',
	// 	url: null
	// },
	morinoiriguti: {
		// 森の入り口
		image: `${FEATURE_IMAGE_BASE_PATH}/morinoiriguti/01.webp`,
		description: 'コナラの木に設置された森の入り口の看板',
		url: 'https://morinos.net/what-is-morinos/'
	},
	nagamenoiwa: {
		// 眺めの岩
		image: `${FEATURE_IMAGE_BASE_PATH}/nagamenoiwa/01.webp`,
		description: '',
		url: null
	},
	oosugi: {
		// 大杉
		image: `${FEATURE_IMAGE_BASE_PATH}/oosugi/01.webp`,
		description: '樹齢約100年のヒノキ林に混在する大径のスギ。このスギにオオタカが毎年営巣する。',
		url: null
	},
	sumiyakigoya: {
		// 炭焼き小屋
		image: `${FEATURE_IMAGE_BASE_PATH}/sumiyakigoya/01.webp`,
		description:
	...
	umanoseiwa: {
		image: `${FEATURE_IMAGE_BASE_PATH}/umanoseiwa/01.webp`,
		description: '',
		url: null
	},
	yamanokami: {
		// 山の神
		image: `${FEATURE_IMAGE_BASE_PATH}/yamanokami/01.webp`,
		description:
