...
export interface MatchStyleDict {
	colors: MatchColorDict;
	patterns?: MatchPatternDict;
}

const treeSpeciesMatchStyleDict: MatchStyleDict = {
	colors: {
		スギ: '#33a02c',
		ヒノキ: '#b2df8a',
		アカマツ: '#e31a1c',
...
export const matchStyleDicts = {
	treeSpecies: treeSpeciesMatchStyleDict
} as const satisfies Record<string, MatchStyleDict>;

export type MatchStyleDictName = keyof typeof matchStyleDicts;
