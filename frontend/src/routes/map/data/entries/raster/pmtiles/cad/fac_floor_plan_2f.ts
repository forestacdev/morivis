...
import { DEFAULT_RASTER_BASEMAP_INTERACTION } from '$routes/map/data/entries/raster/style';
import { ENTRY_PMTILES_RASTER_PATH } from '$routes/constants';

const entry: RasterPMTilesEntry<RasterCadStyle> = {
	id: 'fac_floor_plan_2f',
	type: 'raster',
	format: {
		type: 'pmtiles',
		url: `${ENTRY_PMTILES_RASTER_PATH}/fac_floor_plan_2f.pmtiles`
	},
	metaData: {
		name: 'アカデミー施設 2F 平面図',
		description: '',
		...
		xyzImageTile: { x: 1846186, y: 826711, z: 21 }
	},
	interaction: {
