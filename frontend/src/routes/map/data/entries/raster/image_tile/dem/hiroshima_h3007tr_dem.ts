...
const entry: RasterImageEntry<RasterDemStyle> = {
	id: 'hiroshima_h3007tr_dem',
	type: 'raster',
	format: {
		type: 'image',
		url: 'https://rinya-tiles.geospatial.jp/dem_h3007tr_2025/{z}/{x}/{y}.png'
	},
	metaData: {
		name: '平成30年7月豪雨 数値標高データ',
		sourceDataName: 'DEMラスタタイル-PNG標高タイルXYZ',
		description:
			'平成30年7月豪雨の対象地域の標高値をPNG標高タイルで配信したデータ。標高値の参照や地形表現の基盤として利用できる。',
		attribution: '林野庁',
		location: '広島県',
		tags: ['DEM', '地形', 'ハザード'],
		minZoom: 8,
