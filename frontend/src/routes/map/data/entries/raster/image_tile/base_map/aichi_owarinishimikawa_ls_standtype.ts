...
const entry: RasterImageEntry<RasterBaseMapStyle> = {
	id: 'aichi_owarinishimikawa_ls_standtype',
	type: 'raster',
	format: {
		type: 'image',
		url: 'https://rinya-tiles.geospatial.jp/ls_standtype_078_2025/{z}/{x}/{y}.webp'
	},
	metaData: {
		name: '尾張西三河森林計画区 林相識別図',
		sourceDataName: '林相識別図ラスタタイルXYZ',
		description:
			'尾張西三河森林計画区の林相識別図をラスタタイル化したデータ。森林の林相分布を地図上で確認する際に利用できる。',
