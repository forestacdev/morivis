import type { RasterCategoricalStyle, RasterPMTilesEntry } from '$map/data/types/raster';

export const pmTilesRasterCategoricalEntry: RasterPMTilesEntry<RasterCategoricalStyle>[] = [
	{
