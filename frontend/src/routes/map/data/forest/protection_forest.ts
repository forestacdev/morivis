 ...
 * 保安林17種類の辞書データ
 */
export const ProtectionForestTypes: Record<ProtectionForestCodeType, ProtectionForestType> = {
	// ---------------------------------------------------------------------------
	// 1号：水源かん養保安林
	// ---------------------------------------------------------------------------
	'01': {
 ...
 * 保安林コードから詳細情報を取得
 */
export function getProtectionForestType(code: ProtectionForestCodeType): ProtectionForestType {
...
export function getProtectionForestsByCategory(
	...
	return Object.values(ProtectionForestTypes).filter((type) => type.category === category);
}
 ...
 * カテゴリの日本語名称
 */
export const ProtectionForestCategoryNames: Record<ProtectionForestCategoryType, string> = {
 ...
 */
export const ProtectionForestAreaReference: Partial<Record<ProtectionForestCodeType, number>> = {
