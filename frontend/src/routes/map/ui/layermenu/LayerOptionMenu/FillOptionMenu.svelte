<script lang="ts">
	...
	import AccordionToggle from '$routes/map/ui/atoms/AccordionToggle.svelte';
	import { fade, slide } from 'svelte/transition';
	import { flip } from 'svelte/animate';
	import { spin } from '$lib/animation/transition';

	$: colorStyle = fillStyle.color[fillStyleKey];
</script>

<div class="bg-gray-600 p-2">
	<AccordionToggle bind:value={fillStyle.show} label="塗りつぶし" />

	{#if fillStyle.show}
		<div in:spin={{ duration: 500 }} out:spin={{ duration: 500 }}>
