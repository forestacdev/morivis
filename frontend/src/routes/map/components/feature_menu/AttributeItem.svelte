...
<div class="flex flex-col items-start justify-center">
	...
	<div class="w-full p-2 pl-6">
		<button
			...
			class="relative flex w-full cursor-pointer items-center justify-between rounded-md bg-black p-2 pl-4 text-left text-base transition-colors duration-150"
			><span>{value}</span>
			{#if isHover}
