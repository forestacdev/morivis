<script lang="ts">
	...
	import fragmentShaderSource from '$map/CanvasLayer/shader/fragment.glsl?raw';
	import vertexShaderSource from '$map/CanvasLayer/shader/vertex.glsl?raw';
	import { selectedHighlightData, type SelectedHighlightData } from '$map/store';
	...
	onMount(() => {
		...
		const setHighlightData = (_selectedHighlightData: SelectedHighlightData) => {
			...
			const features = map.queryRenderedFeatures({
				layers: [_selectedHighlightData.layerData.id]
			});
