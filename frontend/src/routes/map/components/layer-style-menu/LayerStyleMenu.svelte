<script lang="ts">
	...
	import RasterOptionMenu from '$routes/map/components/layer-style-menu/RasterOptionMenu.svelte';
	import VectorOptionMenu from '$routes/map/components/layer-style-menu/VectorOptionMenu.svelte';
