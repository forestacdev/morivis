<script lang="ts">
	...
	import ColorExpressionsOption from '$routes/components/layer_menu/layer_option_menu/extension_menu/ColorExpressionsOption.svelte';
	import NumberExpressionsOption from '$routes/components/layer_menu/layer_option_menu/extension_menu/NumberExpressionsOption.svelte';
	import type {
		ColorsExpression,
		NumbersExpression,
		LabelsExpressions,
