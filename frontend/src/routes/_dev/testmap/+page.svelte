<script lang="ts">
   ...
   const initialStyle = {
    ...
    layers: [
        ...
        { id: 'num-layer-1', type: 'circle', source: 'num-source-1', paint: { 'circle-radius': 3 } },
        { id: 'num-layer-2', type: 'circle', source: 'num-source-2', paint: { 'circle-radius': 3 } },
        ...
        { id: 'symbol-layer', type: 'circle', source: 'symbol-source', paint: { 'circle-radius': 3 } },
...
<div id="map" class='h-dvh w-full top-0 absolute'></div>
